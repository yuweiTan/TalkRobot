...
public class TalkRobotApplicationTests {
	...
	private static String robot() {
		...
		try {
			...
			com.entity.PO.robot.RequestPO requestPO = new com.entity.PO.robot.RequestPO(user_id, query);
			com.entity.PO.robot.ParamsPO paramsPO = new com.entity.PO.robot.ParamsPO(version, service_id, log_id, session_id, requestPO);
